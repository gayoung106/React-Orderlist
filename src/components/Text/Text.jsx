...
const Text = (props) => {
    ...
    return (
        <span content={content} fontFamily={fontFamily} fontSize={fontSize} style={style} className={className} padding={padding} margin={margin} color={color} customstyle={customStyle} >
            {content}
        </span>
    )
}
